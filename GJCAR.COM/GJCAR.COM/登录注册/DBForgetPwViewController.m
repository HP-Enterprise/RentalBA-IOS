...
@interface DBForgetPwViewController ()

@property (nonatomic,strong)UIView *tipView;

@end

@implementation DBForgetPwViewController
...
-(void)setNavigation
{
    ...
    DBNavgationView * nav = [[DBNavgationView alloc]initNavgationWithTitle:@"忘记密码" withLeftBtImage:@"back" withRightImage:nil withFrame:CGRectMake(0, 0, ScreenWidth , 64)];
...
//        NSString * url = @"http://www.rental.hpecar.com/api/verify";
        ...
        net.verifyCodeBlock = ^(NSDictionary *dic)
        {
            if ([[dic objectForKey:@"status"]isEqualToString:@"true"])
            {
                ...
                reset.userName = userNameField.field.text;
                reset.code = ValidateField.field.text;
                time = 0;
