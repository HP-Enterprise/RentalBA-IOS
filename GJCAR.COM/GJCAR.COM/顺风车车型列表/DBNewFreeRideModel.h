//
//  DBNewFreeRideModel.h
//  GJCAR.COM
//
//  Created by 段博 on 16/8/3.
...
@interface DBNewFreeRideModel : JSONModel
...
@property (strong, nonatomic) NSString<Optional>* vehicleId;
@property (strong, nonatomic) NSString<Optional>* vendorId;
